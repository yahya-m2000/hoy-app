...
export const DateSelectionProvider: React.FC<{ children: ReactNode }> = ({
  ...
  const processQueue = useCallback(async () => {
    ...
    try {
      // Check if we already have dates for this property in state
      ...
      // Otherwise, fetch booked dates for property
      ...
      // Store the found dates in our context
      const updatedPropertyDates = new Map(propertyDates);
      ...
      setPropertyDates(updatedPropertyDates);
