...
export const Button: React.FC<ButtonProps> = ({
  ...
  const getBorderColor = () => {
    ...
    switch (variant) {
      case "outline":
        return isDark ? theme.colors.gray[300] : theme.colors.gray[700];
      case "primary":
        return theme.primary[500];
      case "secondary":
        return theme.secondary[500];
  ...
  const getTextColor = () => {
    if (disabled)
      return isDark ? theme.colors.gray[500] : theme.colors.gray[500];
    ...
    switch (variant) {
      ...
      case "outline":
      case "ghost":
        return isDark ? theme.colors.gray[300] : theme.colors.gray[800];
      default:
        return theme.white;
    }
  };
