...
export const hideTabBarGlobally = () => {
  ...
  if (!globalTabBarAnimation) {
    console.log("No global tab bar animation initialized!");
    return;
  }
  ...
  console.log("Hiding tab bar with height:", tabBarHeight);
  ...
  Animated.parallel([
    ...
    console.log("Tab bar hide animation completed");
  });
};
...
export const showTabBarGlobally = () => {
  ...
  Animated.parallel([
    ...
    console.log("Tab bar show animation completed");
  });
};
