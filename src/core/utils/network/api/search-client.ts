 ...
 * Ensures validation and proper error handling for property queries.
 * 
 * @module @core/utils/api/property-search
 * @author Hoy Development Team
 * @version 1.0.0
 */

import { searchProperties } from "@core/api/services/property/property.service";
import { formatCoordinateParams } from "src/core/utils/data/validation/coordinate-validator";
