 ...
 *
 * Intelligently parses location strings to properly categorize cities, 
 * states, and countries with support for multiple geographic regions.
 * 
 * @module @core/utils/location/location-parser
 * @author Hoy Development Team
 * @version 1.0.0
 */

import { ParsedLocation } from '@core/types/location.types';

// Re-export for backward compatibility
export { ParsedLocation };
 ...
 * @returns Parsed location with city, state, country components
 * 
 * @example
 * parseLocation("Malibu, California, United States")
 * // → { city: "Malibu", state: "California", country: "United States" }
 * 
 * @example
 * parseLocation("California, United States")
 * // → { state: "California", country: "United States" }
 * 
 * @example
 * parseLocation("Paris, France")
