...
// We'll use a more flexible payment method type that's compatible with existing component
...
interface PaymentMethodStepProps extends BookingStepProps {
  selectedMethod: ExtendedPaymentMethod | null;
  onSelectMethod: (method: ExtendedPaymentMethod) => void;
}
