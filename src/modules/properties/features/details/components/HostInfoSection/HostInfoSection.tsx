...
import { Container, Text, Icon, Button, Avatar } from "@shared/components/base";
              ...
              <Container marginBottom="xs">
                <Text variant="body" color={theme.text.secondary}>
                  {host.yearsHosting === 0
                    ? "New host"
                    : `${host.yearsHosting} ${
                        host.yearsHosting === 1 ? "year" : "years"
                      } hosting`}
                </Text>
              </Container>
            )}
        ...
        <Container flexDirection="row" flex={1} style={{ gap: spacing.md }}>
          ...
          <Container flex={1}>
            <Button
              ...
              iconPosition="left"
              style={{
                borderColor: host.phoneNumber
                  ? theme.colors.gray[300]
                  : theme.colors.gray[200],
                paddingVertical: spacing.md,
                opacity: host.phoneNumber ? 1 : 0.6,
              }}
            />
          </Container>
          ...
          <Container flex={1}>
            <Button
              ...
              iconPosition="left"
              style={{
                borderColor: host.whatsappNumber
                  ? theme.colors.gray[300]
                  : theme.colors.gray[200],
                paddingVertical: spacing.md,
                opacity: host.whatsappNumber ? 1 : 0.6,
              }}
            />
          </Container>
        </Container>
