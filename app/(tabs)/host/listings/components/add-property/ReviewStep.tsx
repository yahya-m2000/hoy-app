  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.stepSubtitle}>
        Please review your property details before {isEditMode ? 'updating' : 'creating'} your listing.
      </Text>
        ...
        <View style={styles.overviewCard}>
          ...
          <View style={styles.overviewContent}>
            ...
            <Text style={styles.propertyType}>
              {formData.propertyType.charAt(0).toUpperCase() + formData.propertyType.slice(1)} • {formData.type}
            </Text>
            ...
            <View style={styles.propertyStats}>
              <View style={styles.stat}>
                ...
                <Text style={styles.statText}>{formData.bedrooms} bed{formData.bedrooms !== 1 ? 's' : ''}</Text>
              </View>
              <View style={styles.stat}>
                <Ionicons name="water-outline" size={16} color="#666" />
                <Text style={styles.statText}>{formData.bathrooms} bath{formData.bathrooms !== 1 ? 's' : ''}</Text>
              </View>
              <View style={styles.stat}>
                <Ionicons name="people-outline" size={16} color="#666" />
                <Text style={styles.statText}>{formData.maxGuests} guest{formData.maxGuests !== 1 ? 's' : ''}</Text>
              </View>
            </View>
      ...
      {formData.amenities.length > 0 && (
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Amenities ({formData.amenities.length})</Text>
      ...
      {formData.images.length > 0 && (
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Photos ({formData.images.length})</Text>
          <View style={styles.photosGrid}>
            ...
            {formData.images.length > 6 && (
              <View style={styles.morePhotos}>
                <Text style={styles.morePhotosText}>+{formData.images.length - 6} more</Text>
              </View>
            )}
          </View>
        </View>
      ...
      <View style={styles.summarySection}>
        <Text style={styles.summaryTitle}>Ready to {isEditMode ? 'update' : 'publish'}?</Text>
