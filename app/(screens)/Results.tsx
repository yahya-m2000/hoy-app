...
import { formatCoordinateParams } from "../../src/utils/coordinateValidation";
...
export default function SearchResultsScreen() {
  ...
  const filteredAndSortedProperties = useMemo(() => {
    ...
    const processedProperties = dataToFilter.map((property) => ({
      ...property,
      ...
      return (
        <View style={styles.emptyStateContainer}>
          <Ionicons
            ...
            size={48}
            color={isDark ? theme.colors.error[400] : theme.colors.error[500]}
          />
          <Text
            style={[
    ...
    return (
      <View style={styles.emptyStateContainer}>
        <Ionicons
          name="search-outline"
          size={48}
          color={isDark ? theme.colors.gray[700] : theme.colors.gray[400]}
        />
        <Text
          style={[
            styles.emptyStateText,
        ...
        <FlatList
          ...
          refreshControl={
            <RefreshControl
              ...
              tintColor={
                isDark ? theme.colors.gray[300] : theme.colors.primary[500]
              }
            />
          }
        />
