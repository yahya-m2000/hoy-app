...
export default function ReservationModal() {
    ...
    if (selectedPaymentMethod?.type === "zaad") {
      try {
        ...
        if (Platform.OS === "ios") {
          ...
          // Proceed with booking creation after a short delay
          setTimeout(() => {
  ...
  const proceedWithBookingCreation = async (paymentStatus = "confirmed") => {
    ...
    router.push("/(screens)/BookingConfirmationScreen?booking=" + bookingParam);
