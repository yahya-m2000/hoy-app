 ...
 * Allows travelers to leave reviews and ratings for properties they've stayed at
 * Includes star ratings for different aspects like cleanliness, location, etc.
 */
...
import { useCreateBookingReview } from "@common/hooks/useBookings";
...
export default function CreateReviewModal() {
  ...
  // Review mutation
  const createReviewMutation = useCreateBookingReview();
  ...
  const handleSubmitReview = async () => {
    ...
    // Submit review with proper structure
