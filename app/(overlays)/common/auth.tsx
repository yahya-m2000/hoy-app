...
export default function AuthModal() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      // Auto-login after registration using our new login method
      await authLogin(email, password);

      // Debug: Check token storage after registration and login
      console.log("🔍 Checking token storage after registration and login...");
      await debugTokenStorage();
