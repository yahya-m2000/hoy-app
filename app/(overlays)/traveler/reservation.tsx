...
export default function ReservationModal() {
  ...
  const proceedWithBookingCreation = async (paymentStatus = "confirmed") => {
    ...
    const bookingParam = encodeURIComponent(JSON.stringify(completeBooking)); // For ZAAD payments, use router.replace instead of push to avoid navigation back to reservation modal
    if (selectedPaymentMethod?.type === "zaad") {
